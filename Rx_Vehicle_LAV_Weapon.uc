...
class Rx_Vehicle_LAV_Weapon extends Rx_Vehicle_MultiWeapon;
...
DefaultProperties
{
    ...
    VehicleClass=Class'Rx_Vehicle_LAV'

    WeaponFireSnd(0)     = SoundCue'RX_VH_LAV.Sounds.CannonFire'
    WeaponFireTypes(0)   = EWFT_Projectile
    WeaponProjectiles(0) = Class'Rx_Vehicle_LAV_Cannon'
    WeaponFireSnd(1)     = SoundCue'RX_VH_LAV.Sounds.MissileFire'
    WeaponFireTypes(1)   = EWFT_Projectile
    WeaponProjectiles(1) = Class'Rx_Vehicle_LAV_Rocket'
	
	WeaponDistantFireSnd(0)=SoundCue'RX_VH_LAV.Sounds.Cannon_DistantFire'
	WeaponDistantFireSnd(1)=SoundCue'RX_VH_LAV.Sounds.Missile_DistantFire'

	WeaponProjectiles_Heroic(0)= Class'Rx_Vehicle_LAV_Cannon'
	WeaponProjectiles_Heroic(1)= Class'Rx_Vehicle_LAV_Rocket'
 
	WeaponFireSounds_Heroic(0)=SoundCue'RX_VH_LAV.Sounds.CannonFire'
