...
*
*********************************************************/
class FPI_Vehicle_Superhind_Weapon extends Rx_Vehicle_Weapon_Reloadable;
...
DefaultProperties
{
    ...
    VehicleClass=Class'FPI_Vehicle_Superhind'
   ...
   /****************************************/
    ...
    WeaponProjectiles(0) = Class'FPI_Vehicle_Superhind_Projectile'

    WeaponFireSnd(1)     = SoundCue'RX_VH_Apache.Sounds.SC_Apache_Missile'
    WeaponFireTypes(1)   = EWFT_Projectile
    WeaponProjectiles(1) = Class'FPI_Vehicle_Superhind_Projectile'
	
	//Heroic Modifiers
	WeaponProjectiles_Heroic(0)= Class'FPI_Vehicle_Superhind_Projectile_Heroic'
