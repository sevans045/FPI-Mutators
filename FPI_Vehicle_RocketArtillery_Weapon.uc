...
*
*********************************************************/
class FPI_Vehicle_RocketArtillery_Weapon extends Rx_Vehicle_Weapon_Reloadable;
...
DefaultProperties
{
   ...
   VehicleClass=Class'FPI_Vehicle_RocketArtillery'
   ...
   WeaponProjectiles(0) = Class'FPI_Vehicle_RocketArtillery_Projectile_Arc'
   WeaponFireSnd(1)     = SoundCue'RX_VH_RocketArtillery.Sounds.RocketFire'
   WeaponFireTypes(1)   = EWFT_Projectile
   WeaponProjectiles(1) = Class'FPI_Vehicle_RocketArtillery_Projectile_Arc'
